...
/**
 * This class contains all the queries sql
 */
public final class  DBConstants {
    ...
    public static final String GET_COUNT_PASSAGES ="SELECT COUNT(*) as countPassages FROM ticket WHERE ticket.VEHICLE_REG_NUMBER = ?";
}
